...
try:
    ...
    try:
        ...
        print("STARTUP ERROR (ROUTERS):", str(e))
    ...
    import traceback
    print("--- CRITICAL STARTUP TRACEBACK ---")
    traceback.print_exc()
...
async def ai_test_endpoint():
    ...
    try:
        ...
        result = svc.generate_reasoning("hello")
...
def test_deepseek():
    ...
    try:
        svc = get_deepseek_svc()
        result = svc.generate_reasoning("What are the best crops for dry soil?")
...
if __name__ == "__main__":
    ...
    # Enable reload and debug logging for full trace visibility
